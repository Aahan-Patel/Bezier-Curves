...
def connectBezier(bezier1, bezier2):
    p0 = bezier1[-1]
    p1 = bezier2[0]
    xdist = p0[0] - p1[0]
    ydist = p0[1] - p1[1]
...
for i in range(0, numPoints):
    bezier1.append(cubicBezier((5, 0), (6, 1), (7, 1), (8, 0), i / numPoints))
for j in range(0, numPoints):
    bezier2.append(cubicBezier((10, 0), (11, 1), (12, 1), (13, 0), j / numPoints))

points = connectBezier(bezier1, bezier2)
